#UNMARKED MOUSE 2 DATA

#2s10s Mixed CSV analysis

"F:/Shrutika-Operant_Chamber-Training Data/Mouse 2 (Unmarked)/Training CSVs/week25_2s10stt_Day2_10.7.25/decoded_datalog_71025_14524.csv"
...
file_path <- "F:/Shrutika-Operant_Chamber-Training Data/Mouse 2 (Unmarked)/Training CSVs/week25_2s10stt_Day2_10.7.25/decoded_datalog_71025_14524.csv"
...
## ---- Save Patch Summary ----
save_path <- file.path(dirname(file_path), "corrected_patch_summary_M2_Day 2_10.7.25.csv")
...
p1_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = RM_per_NP, fill = factor(travel_time))) +
  ...
  labs(title = "RM/NP by Travel Time 
       (M2_Day 2_10.7.25)", x = "Travel Time (s)", y = "RM per NP") +
...
tt_line <- ggplot(patch_df, aes(x = patch_id, y = travel_time)) +
  ...
  labs(title = "Travel Time Across Patches (M2_Day 2_10.7.25) (Line)", x = "Patch ID", y = "Travel Time (s)") +
  theme_minimal(base_size = 12)

tt_dots <- ggplot(patch_df, aes(x = patch_id, y = travel_time)) +
  geom_point(color = "darkgreen", size = 3, alpha = 0.8) +
  scale_y_continuous(breaks = c(2, 10)) +
  labs(title = "Travel Time Across Patches (M2_Day 2_10.7.25) (Dots)", x = "Patch ID", y = "Travel Time (s)") +
  theme_minimal(base_size = 12)
...
p2_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = reaction_time, fill = factor(travel_time))) +
  geom_bar(stat = "summary", fun = mean, color = "black", width = 0.5) +
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = "Reaction Time (Bar) 
       (M2_Day 2_10.7.25)", x = "Travel Time (s)", y = "Reaction Time (s)") +
  theme_minimal(base_size = 12) +
...
p4 <- patch_df %>%
  ...
  labs(title = "Count of Patches per Travel Time per session (M2_Day 2_10.7.25)", x = "Travel Time (s)", y = "Patch Count") +
  theme_minimal(base_size = 12) +
...
## ---- Save Patch Summary ----
write_csv(patch_df, file.path(dirname(file_path), "corrected_patch_summary_M2_Day 2_10.7.25.csv"))
...
p1_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = RM_per_NP, fill = factor(travel_time))) +
  geom_bar(stat = "summary", fun = mean, color = "black", width = 0.5) +
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = paste("RM/NP by Travel Time (M2_Day 2_10.7.25) [", session_label, "]"), x = "Travel Time (s)", y = "RM per NP") +
...
p2_line <- ggplot(patch_df, aes(x = patch_id, y = travel_time)) +
  ...
  scale_y_continuous(breaks = c(2, 10)) +
  labs(title = paste("Travel Time Across Patches (Line) (M1_Day 2_10.7.25) [", session_label, "]"), x = "Patch ID", y = "Travel Time (s)") +
  theme_minimal(base_size = 11)

p2_dot <- ggplot(patch_df, aes(x = patch_id, y = travel_time)) +
  geom_point(size = 3, color = "darkgreen", alpha = 0.8) +
  scale_y_continuous(breaks = c(2, 10)) +
  labs(title = paste("Travel Time (Dots) (M2_Day 2_10.7.25) [", session_label, "]"), x = "Patch ID", y = "Travel Time (s)") +
  theme_minimal(base_size = 11)
...
p3_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = reaction_time, fill = factor(travel_time))) +
  geom_bar(stat = "summary", fun = mean, color = "black", width = 0.5) +
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = paste("Reaction Time (Bar) (M2_Day 2_10.7.25) [", session_label, "]"), x = "Travel Time (s)", y = "Reaction Time (s)") +
  theme_minimal(base_size = 11) +
...
p4_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = harvest_time, fill = factor(travel_time))) +
  geom_bar(stat = "summary", fun = mean, color = "black", width = 0.5) +
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = paste("Harvest Time (Bar) (M2_Day 2_10.7.25) [", session_label, "]"), x = "Travel Time (s)", y = "Harvest Time (s)") +
  theme_minimal(base_size = 11) +
...
"F:/Shrutika-Operant_Chamber-Training Data/Mouse 2 (Unmarked)/Training CSVs/week25_2s10stt_Day3_11.7.25/decoded_datalog_71125_13819.csv"
...
## ---- Update Your File Path ----
file_path <- "F:/Shrutika-Operant_Chamber-Training Data/Mouse 2 (Unmarked)/Training CSVs/week25_2s10stt_Day3_11.7.25/decoded_datalog_71125_13819.csv"
...
## ---- Save Patch Summary ----
save_path <- file.path(dirname(file_path), "corrected_patch_summary_M2_Day 3_11.7.25.csv")
write_csv(patch_df, save_path)
print(paste("✅ Patch summary saved to:", save_path))
...
p1_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = RM_per_NP, fill = factor(travel_time))) +
  ...
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = "RM/NP by Travel Time 
       (M2_Day 3_11.7.25)", x = "Travel Time (s)", y = "RM per NP") +
  theme_minimal(base_size = 12) +
  scale_fill_brewer(palette = "Set2") +
  theme(plot.title = element_text(size = 14, face = "bold"))
...
tt_line <- ggplot(patch_df, aes(x = patch_id, y = travel_time)) +
  ...
  geom_point(color = "darkred", size = 3) +
  scale_y_continuous(breaks = c(2, 10)) +
  labs(title = "Travel Time Across Patches (M2_Day 3_11.7.25) (Line)", x = "Patch ID", y = "Travel Time (s)") +
  theme_minimal(base_size = 12)

tt_dots <- ggplot(patch_df, aes(x = patch_id, y = travel_time)) +
  geom_point(color = "darkgreen", size = 3, alpha = 0.8) +
  scale_y_continuous(breaks = c(2, 10)) +
  labs(title = "Travel Time Across Patches (M2_Day 3_11.7.25) (Dots)", x = "Patch ID", y = "Travel Time (s)") +
  theme_minimal(base_size = 12)
...
p2_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = reaction_time, fill = factor(travel_time))) +
  ...
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = "Reaction Time (Bar) 
       (M2_Day 3_11.7.25)", x = "Travel Time (s)", y = "Reaction Time (s)") +
  theme_minimal(base_size = 12) +
  scale_fill_brewer(palette = "Pastel1") +
  theme(plot.title = element_text(size = 14, face = "bold"))
...
p4 <- patch_df %>%
  ...
  ggplot(aes(x = factor(travel_time), y = n, fill = factor(travel_time))) +
  geom_bar(stat = "identity", color = "black", width = 0.5) +
  labs(title = "Count of Patches per Travel Time per session (M2_Day 3_11.7.25)", x = "Travel Time (s)", y = "Patch Count") +
  theme_minimal(base_size = 12) +
  scale_fill_brewer(palette = "Accent") +
  theme(plot.title = element_text(size = 14, face = "bold"))
...
## ---- Save Patch Summary ----
write_csv(patch_df, file.path(dirname(file_path), "corrected_patch_summary_M2_Day3_11.7.25.csv"))
...
p1_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = RM_per_NP, fill = factor(travel_time))) +
  geom_bar(stat = "summary", fun = mean, color = "black", width = 0.5) +
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = paste("RM/NP by Travel Time (M2_Day 3_11.7.25) [", session_label, "]"), x = "Travel Time (s)", y = "RM per NP") +
  theme_minimal(base_size = 11) +
  scale_fill_brewer(palette = "Set2") + guides(fill = "none")
...
p2_line <- ggplot(patch_df, aes(x = patch_id, y = travel_time)) +
  ...
  geom_point(size = 3, color = "darkred") +
  scale_y_continuous(breaks = c(2, 10)) +
  labs(title = paste("Travel Time Across Patches (Line) (M1_Day 3_11.7.25) [", session_label, "]"), x = "Patch ID", y = "Travel Time (s)") +
  theme_minimal(base_size = 11)

p2_dot <- ggplot(patch_df, aes(x = patch_id, y = travel_time)) +
  geom_point(size = 3, color = "darkgreen", alpha = 0.8) +
  scale_y_continuous(breaks = c(2, 10)) +
  labs(title = paste("Travel Time (Dots) (M2_Day 3_11.7.25) [", session_label, "]"), x = "Patch ID", y = "Travel Time (s)") +
  theme_minimal(base_size = 11)
...
p3_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = reaction_time, fill = factor(travel_time))) +
  geom_bar(stat = "summary", fun = mean, color = "black", width = 0.5) +
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = paste("Reaction Time (Bar) (M2_Day 3_11.7.25) [", session_label, "]"), x = "Travel Time (s)", y = "Reaction Time (s)") +
  theme_minimal(base_size = 11) +
  scale_fill_brewer(palette = "Pastel1") + guides(fill = "none")
...
p4_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = harvest_time, fill = factor(travel_time))) +
  geom_bar(stat = "summary", fun = mean, color = "black", width = 0.5) +
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = paste("Harvest Time (Bar) (M2_Day 3_11.7.25) [", session_label, "]"), x = "Travel Time (s)", y = "Harvest Time (s)") +
  theme_minimal(base_size = 11) +
  scale_fill_brewer(palette = "Pastel2") + guides(fill = "none")
...
"F:/Shrutika-Operant_Chamber-Training Data/Mouse 2 (Unmarked)/Training CSVs/week25_2s10stt_Day4_14.7.25/decoded_datalog_71425_14828.csv"
...
## ---- Update Your File Path ----
file_path <- "F:/Shrutika-Operant_Chamber-Training Data/Mouse 2 (Unmarked)/Training CSVs/week25_2s10stt_Day4_14.7.25/decoded_datalog_71425_14828.csv"
...
## ---- Save Patch Summary ----
save_path <- file.path(dirname(file_path), "corrected_patch_summary_M2_Day 4_14.7.25.csv")
write_csv(patch_df, save_path)
print(paste("✅ Patch summary saved to:", save_path))
...
p1_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = RM_per_NP, fill = factor(travel_time))) +
  ...
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = "RM/NP by Travel Time 
       (M2_Day 4_14.7.25)", x = "Travel Time (s)", y = "RM per NP") +
  theme_minimal(base_size = 12) +
  scale_fill_brewer(palette = "Set2") +
  theme(plot.title = element_text(size = 14, face = "bold"))
...
tt_line <- ggplot(patch_df, aes(x = patch_id, y = travel_time)) +
  ...
  geom_point(color = "darkred", size = 3) +
  scale_y_continuous(breaks = c(2, 10)) +
  labs(title = "Travel Time Across Patches (M2_Day 4_14.7.25) (Line)", x = "Patch ID", y = "Travel Time (s)") +
  theme_minimal(base_size = 12)

tt_dots <- ggplot(patch_df, aes(x = patch_id, y = travel_time)) +
  geom_point(color = "darkgreen", size = 3, alpha = 0.8) +
  scale_y_continuous(breaks = c(2, 10)) +
  labs(title = "Travel Time Across Patches (M2_Day 4_14.7.25) (Dots)", x = "Patch ID", y = "Travel Time (s)") +
  theme_minimal(base_size = 12)
...
p2_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = reaction_time, fill = factor(travel_time))) +
  ...
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = "Reaction Time (Bar) 
       (M2_Day 4_14.7.25)", x = "Travel Time (s)", y = "Reaction Time (s)") +
  theme_minimal(base_size = 12) +
  scale_fill_brewer(palette = "Pastel1") +
  theme(plot.title = element_text(size = 14, face = "bold"))
...
p4 <- patch_df %>%
  ...
  ggplot(aes(x = factor(travel_time), y = n, fill = factor(travel_time))) +
  geom_bar(stat = "identity", color = "black", width = 0.5) +
  labs(title = "Count of Patches per Travel Time per session (M2_Day 4_14.7.25)", x = "Travel Time (s)", y = "Patch Count") +
  theme_minimal(base_size = 12) +
  scale_fill_brewer(palette = "Accent") +
  theme(plot.title = element_text(size = 14, face = "bold"))
...
## ---- Save Patch Summary ----
write_csv(patch_df, file.path(dirname(file_path), "corrected_patch_summary_M2_Day4_14.7.25.csv"))
...
p1_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = RM_per_NP, fill = factor(travel_time))) +
  geom_bar(stat = "summary", fun = mean, color = "black", width = 0.5) +
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = paste("RM/NP by Travel Time (M2_Day 4_14.7.25) [", session_label, "]"), x = "Travel Time (s)", y = "RM per NP") +
  theme_minimal(base_size = 11) +
  scale_fill_brewer(palette = "Set2") + guides(fill = "none")
...
p2_dot <- ggplot(patch_df, aes(x = patch_id, y = travel_time)) +
  geom_point(size = 3, color = "darkgreen", alpha = 0.8) +
  scale_y_continuous(breaks = c(2, 10)) +
  labs(title = paste("Travel Time (Dots) (M2_Day 4_14.7.25) [", session_label, "]"), x = "Patch ID", y = "Travel Time (s)") +
  theme_minimal(base_size = 11)
...
p3_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = reaction_time, fill = factor(travel_time))) +
  geom_bar(stat = "summary", fun = mean, color = "black", width = 0.5) +
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = paste("Reaction Time (Bar) (M2_Day 4_14.7.25) [", session_label, "]"), x = "Travel Time (s)", y = "Reaction Time (s)") +
  theme_minimal(base_size = 11) +
  scale_fill_brewer(palette = "Pastel1") + guides(fill = "none")
...
p4_bar <- ggplot(patch_df_clean, aes(x = factor(travel_time), y = harvest_time, fill = factor(travel_time))) +
  geom_bar(stat = "summary", fun = mean, color = "black", width = 0.5) +
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.2) +
  labs(title = paste("Harvest Time (Bar) (M2_Day 4_14.7.25) [", session_label, "]"), x = "Travel Time (s)", y = "Harvest Time (s)") +
  theme_minimal(base_size = 11) +
  scale_fill_brewer(palette = "Pastel2") + guides(fill = "none")
