...
reward_step <- 15  # Step for reward depletion
```

```{r}
# Define trial numbers and rewards
trial_number <- 1:15  # Maximum trial number (rewards deplete from 210 to 0)
...
CT <- 1  # Cycle time in seconds
TT <- 7  # Travel time in seconds
reward_start <- 80  # Starting reward
decay_factor <- 0.82  # Exponential decay factor
